...
app = modal.App(
    image=(
        ...
        .run_commands("rclone copy --multi-thread-streams=16 --update \"GDrive16T:/Loras/muk_monsieur\" \"/root/content/drive/MyDrive/Loras/muk_monsieur\" --ignore-existing --checksum --transfers 16 -v --stats 10s")

        #rclone copy --multi-thread-streams=16 --update "/root/content/drive/MyDrive/Loras/muk_monsieur/output" "GDrive16T:/Loras/muk_monsieur/output" --ignore-existing --checksum --transfers 16 -v --stats 10s
